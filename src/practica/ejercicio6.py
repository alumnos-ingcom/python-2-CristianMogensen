...
def ajustar_a_rango(numero: int, pasos: int, num1: int, num2: int):
    ...
    assert (isinstance(numero, int)), "El número debe ser un número entero (int)."
    
    # Verifico que 'pasos' (la cantidad de rotaciones) sea un entero
    # (int).
    assert (isinstance(pasos, int)), "Los 'pasos' deben ser un número entero (int)."
    
    # Verifico que 'num1' (extremo inferior) sea un entero (int).
    assert (isinstance(num1, int)), "'num1', extremo inferior, debe ser un número entero (int)."
    
    # Verifico que 'num2' (extremo superior) sea un entero (int).
    assert (isinstance(num2, int)), "'num2', extremo superior, debe ser un número entero (int)."
...
def codificar_cifrado(texto: str,
    ...
    assert (isinstance(texto, str)), "El 'texto' debe ser de tipo string (str)."
    
    # Verifico que el número de rotación del cifrado sea un número
    # entero (int).
    assert (isinstance(posiciones, int)), "La variable 'posiciones' debe ser de tipo entero (int)."
...
def decodificar_cifrado(texto_cifrado: str,
    ...
    # Verifico que el texto ingresado sea un string (str).
    assert (isinstance(texto_cifrado, str)), "El 'texto' debe ser de tipo string (str)."
