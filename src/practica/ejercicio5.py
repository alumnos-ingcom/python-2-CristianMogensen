...
def hay_balanceo_especifico(texto: str,
    ...
    # o se "cierra".
    # Uso variable para seguir el formato de pycodestyle.
    error1: str = "Los símbolos de apertura y cierre no pueden ser iguales."
    assert (inicio != cierre), error1

    # Verifico que la longitud del string 'inicio' sea 1.
    # Uso variable para seguir el formato de pycodestyle.
    error2: str = "El símbolo de 'inicio' posee más de un caracter."
    assert (len(inicio) == 1), error2

    # Verifico que la longitud del string 'cierre' sea 1.
    # Uso variable para seguir el formato de pycodestyle.
    error3: str = "El símbolo de 'cierre' posee más de un caracter."
    assert (len(cierre) == 1), error3
